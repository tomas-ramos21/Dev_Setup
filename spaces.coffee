...
render: (output) ->
        ...
        sub = "<span class=\"desktop#{index + 1}Div\" style=\"color: rgba(205,224,159,1)\">"
        """
        <div>
          <p class="\firstline"\>
            <span class=\"appleDiv\">
...
style: """
  ...
  color: black
  position: absolute
  background-color: rgba(45, 52, 72, 1);
  display: flex;
  align-items: center;
